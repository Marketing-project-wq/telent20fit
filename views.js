...
/* Per-brand container overrides (data-eco slug). Higher specificity than the
   ...
   without affecting the others. 20FIT Shop is pinned to its own fixed size. */
...
@media(max-width:860px){.resp3{grid-template-columns:1fr 1fr !important}.eco-grid{grid-template-columns:1fr 1fr !important}.eco-card.eco-card-logo{--eco-w:120px;--eco-h:36px}.eco-card.eco-card-logo[data-eco="shop"]{--eco-w:120px;--eco-h:36px}}
...
@media(max-width:560px){.resp3{grid-template-columns:1fr 1fr !important;gap:12px}.eco-card{font-size:15px;min-height:74px;padding:18px 8px}.eco-card.eco-card-logo{--eco-w:100px;--eco-h:32px;padding:14px 12px}.eco-card.eco-card-logo[data-eco="shop"]{--eco-w:100px;--eco-h:32px}.coach-grid{gap:12px}.coach-card{flex:1 1 calc(50% - 6px);min-width:0;max-width:calc(50% - 6px)}}
